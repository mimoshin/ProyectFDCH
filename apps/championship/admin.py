...
from .models import (championship, champ_log, category, champ_category, stage, stage_log, 
                     ...
                     trackAsignation,jumpAsignation,throwAsignation)
# Register your models here.
...
admin.site.register(jumpAsignation)
admin.site.register(throwAsignation)
admin.site.register(trackAsignation)
