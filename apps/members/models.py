...
class athlete(models.Model):
    ...
    first_name = models.CharField(max_length=200,default='primer_nombre')
    second_name = models.CharField(max_length=200,default='segundo_nombre')
    flast_name = models.CharField(max_length=200,default='primer_apellido')
    slast_name = models.CharField(max_length=200,default='segundo_apellido')
    birth = models.DateField(default='2021-07-25')
    ...
    height = models.CharField(max_length=4, default='None')
    cellphone = models.CharField(max_length=9, default='None')
    email = models.CharField(max_length=30, default='None')
    coach = models.CharField(max_length=10, default='None')
    ...
    def determinate_category(self):
        ...
        """
        year = datetime.now()
        diference = year.year - self.birth.year
        if diference > 22:
            return 7
        elif diference >35:
            return 8
        ...
        try:
            if data.get('category'):
                if data['category'] == '5':
                    ...
                    athletes = athlete.objects.filter(first_name__icontains=data['name'], categoria=data['category'])
            else:
                athletes = athlete.objects.filter(first_name__icontains=data['name'])
            return athletes
        except Exception as e:
