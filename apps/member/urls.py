...
from .views import FedachiAdminAthletes, FedachiAdminChampionships, FedachiAdminClubs, FedachiAdminCompetitions, FedachiAdminEvents, FedachiAdminInscriptions, newClub, principalAdminsView, principalAthletesView

urlpatterns = [
    path('',principalAdminsView,name='principalAminsView'),
    path('all',principalAthletesView,name='athletesPrincipal'),
